...
The number of leaf nodes l in a perfect binary tree is 
 ...
 (by using the above property) and the number of leaves is 
...
. The proof is the following. For a perfect binary tree, the total number of nodes is 
...
With given n nodes, the minimum possible tree height is 
...
. With a given height h, the number of leaves at that height can't exceed 
 ...
 as the number of leaves at the height in a perfect tree. Thus 
